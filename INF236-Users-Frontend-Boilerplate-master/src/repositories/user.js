...
const getBynombre = (nombre,pass) =>
		axios
			.get(`${process.env.REACT_APP_BACKEND_URL}/users/${nombre}/${pass}`)
			.then((res) => res.data);

// eslint-disable-nextline
export { deleteUser, updateUser, createUser, getAllUsers, getUser, getBynombre };
