...
import AprobForm from "./aprob_Deri";
import RechForm from "./rech_Deri";
import {aprobarDeriSoli,rechazarDeriSoli} from "../../repositories/derivados";
  ...
  if (a != 0){
	...
	return (
        ...
        <form className="cbp-mc-form">
          ...
          {!estado && (
              <>
                <AprobForm id={id} callback={aprobarDeriSoli} />
                <RechForm id={id} callback={rechazarDeriSoli} />
                <p></p>
              </>
            )}
          </div>
